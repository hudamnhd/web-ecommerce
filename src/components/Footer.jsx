  ...
  return (
    <footer>
          ...
          {[1, 2, 3].map((index) => (
            ...
            >
              ...
              {categories.map((category) => (
                <button
                  key={category}
                  className=" capitalize text-gray-700 hover:text-sky-500"
                >
                  {category}
                </button>
              ))}
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-y-6 justify-between my-6">
        <div>
          <h3 className="font-medium mb-2 text-slate-800 text-base">
        ...
        <form className="flex gap-x-1.5 max-w-sm">
          ...
          />
          <button className="py-1.5 px-4 text-white bg-blue-600 font-medium hover:bg-blue-600 rounded-md duration-300">
            Subcribe
          </button>
        </form>
      </div>
